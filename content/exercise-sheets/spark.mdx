...
1. Write a Spark application which ingests the following CSV file, create a new
   column, and write the data in a PostgreSQL database:

   ```csv fp=data/authors.csv nu
   lname,fname
   Pascal,Blaise
   Voltaire,François
   Perrin,Jean-Georges
   ...
   public class App {
     ...
     private void start() {
       ...
       String dbConnectionUrl = "jdbc:postgresql://postgres/spark";
