...
7. Create a page programatically for each blog post.
   ...
   ```jsx fp=src/pages/blog/index.js nu hl=2..3,11..15,33
   import * as React from "react"
...
8. Add a hero image for each blog post.
   ...
   ```mdx fp=blog/my-first-post/index.mdx
   ---
   title: "My First Post"
   date: "2021-07-23"
   ...
   ```mdx fp=blog/another-post/index.mdx
   ---
   title: "Another Post"
   date: "2021-07-24"
   ...
   ```mdx fp=blog/yet-another-post/index.mdx
   ---
   title: "Yet Another Post"
   date: "2021-07-25"
   ...
   ```jsx fp=src/pages/blog/{mdx.slug}.js nu hl=4,8,11..21,28,30,33..41
   import * as React from "react"
   import { graphql } from "gatsby"
   import { MDXRenderer } from "gatsby-plugin-mdx"
